...
impl JiraDatabase {
    ...
    pub fn delete_story(&self, epic_id: u32, story_id: u32) -> Result<()> {
        ...
        let story_index = epic.stories.iter().position(|id| id == &story_id).ok_or_else(|| anyhow!(
            "Story ID not found in epic stories vector!"
        ))?;
...
mod tests {
    use super::*;
    use super::test_utils::MockDatabase;
    ...
    fn create_story_should_error_if_invalid_epic_id() {
        ...
        let story = Story::new("".to_owned(), "".to_owned());
        let non_existent_epic_id = 21412;
    ...
    fn delete_epic_should_error_if_invalid_epic_id() {
        ...
        let non_existent_epic_id = 124124;
    ...
    fn delete_story_should_error_if_invalid_epic_id() {
        ...
        let story_id = result.unwrap();
        let non_existent_epic_id = 12421;
    ...
    fn delete_story_should_error_if_story_not_found_in_epic() {
        ...
        let non_existent_story_id = 12421;
